        ...
        <section id="home">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-12  pt-5 ">
                    ...
                    <buttton class="btn btn-primary my-lg-3 my-3"><a href="<?php echo e(route('login')); ?>" class="nav-link">Get started</a></buttton>
                </div>  
                <div class="col-lg-6">
...
</html><?php /**PATH C:\xampp\htdocs\bike\Bike-app\resources\views/home.blade.php ENDPATH**/ ?>