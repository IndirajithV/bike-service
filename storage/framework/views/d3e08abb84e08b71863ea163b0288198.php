            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-8 col-md-6 m-auto">
                    <div class="card border-0 shadow">
                        ...
                        <div class="card-body">
                            <form action="<?php echo e(route('leo')); ?>" method="post">
                              <?php echo csrf_field(); ?>
                                ...
                                <p><h6 class="mt-2">Don't have an account?<a href="<?php echo e(route('register')); ?>" class="nav-link">Register</a></h6></p>
                                </div>
                            </form>
                        </div>
                    </div>
...
</html><?php /**PATH C:\xampp\htdocs\bike\Bike-app\resources\views/login.blade.php ENDPATH**/ ?>